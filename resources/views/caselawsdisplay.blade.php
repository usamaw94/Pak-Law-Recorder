                ...
                <div class="list-container container-fluid">
                    ...
                    <div class="row">
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            ...
                            <ul class="list-unstyled">
                                @foreach($caseCitings as $ct)
                                    <a href="/caseCiting/{{ $ct->citation }}" target="_blank" class="left-link"><li class="left-list">{{ $cc->casecited }}</li></a>
                                @endforeach
                            </ul>
                        </div>
                    </div>
                    ...
                    <div class="right-heading-content">
                        <div class="row">
                            <div class="col-md-offset-10 col-md-2">
                                <a href="{{ asset('/documents/Caselaw/'.$caselaw[0]->file_name) }}" download="{{ $caselaw[0]->title }}.pdf"><button class="btn btn-download"><span class="glyphicon glyphicon-download"></span>&nbsp;&nbsp;Download</button></a>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-12">
                                <h3 style="text-align: center">{{ $caselaw[0]->title }}</h3>
                            </div>
                        </div>
                        <div class="row">
                            ...
                            <div class="col-md-5">
                                <p class="right-data">{{ $caselaw[0]->court }}</p>
                            </div>
                            <div class="col-md-1 right-heading">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <p class="right-data">
                                    ...
                                    <strong><br><br>Petition dismissed.</strong><br>
                                </p>
                            </div>
                        </div>
                    </div>
