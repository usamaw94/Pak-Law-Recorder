                ...
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <ul class="list-unstyled">
                            ...
                            <a class="left-link" href="<?php echo $_SERVER['REQUEST_URI']."?". $_SERVER['QUERY_STRING']."&order=relevance"; ?>" ><li class="left-list list-active">Relevance</li></a>
                            <a class="left-link" href="<?php echo $_SERVER['REQUEST_URI']."?". $_SERVER['QUERY_STRING']."&order=court"; ?>" ><li class="left-list">Court</li></a>
                            <a class="left-link" href="<?php echo $_SERVER['REQUEST_URI']."?". $_SERVER['QUERY_STRING']."&order=date"; ?>" ><li class="left-list">Date</li></a>
                            <a class="left-link" href="<?php echo $_SERVER['REQUEST_URI']."?". $_SERVER['QUERY_STRING']."&order=title"; ?>" ><li class="left-list">Alphabetical</li></a>
                        </ul>
                    </div>
                </div>
            </div>
                    ...
                    <div class="case">
                        <div class="row">
                            <div class="col-xs-12 col-md-12 col-sm-12 col-lg-12">            
                                <h4> <?php echo $mydata['title']; ?></h4>      
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-6 col-sm-6 col-lg-6">
                                <p><b>Court:</b> <?php echo $mydata['court']; ?><br>
                                    <b>Equivalent Citation:</b> <?php echo $mydata['citation']; ?></p>
                            </div>
                            <div class="col-md-6 col-sm-6 col-lg-6">
                                <p><b>Date:</b>  <?php echo $mydata['date'];?><br>
                                    <a href="/display?citation=<?php echo urlencode($mydata['citation']); ?>">View</a>&nbsp;&nbsp;&nbsp;
                                 <a>Download</a></p>
                            </div>
                        </div>
                    </div>
